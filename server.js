...
const WebcastPushConnection = tiktokConnector.WebcastPushConnection;
...
tiktokLiveConnection.connect().catch(err => { console.log('TikTok non in Live:', err); });
...
}); } catch (e) { console.log('Errore client TikTok:', e); }
